...
define_clock  {n:clkm}  -name {clkm}  -freq 100.00 -clockgroup cpu_clkgroup
define_clock  {n:clkvgap} -name {clkvgap}  -clockgroup vga_clkgroup
define_clock  {n:clk65}          -name {clk65} -freq 65.000 -clockgroup vga65_clkgroup
define_clock  {n:clk40}          -name {clk40} -freq 40.000 -clockgroup vga40_clkgroup
define_clock  {n:clk25}          -name {clk25} -freq 25.000 -clockgroup vga25_clkgroup
